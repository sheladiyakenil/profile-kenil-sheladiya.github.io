...
$(document).ready(function() {
 ...
 if($('.personal-imeges').length > 0 ){
        $('.personal-imeges').slick({
            autoplay: true, 
            slidesToShow: 1,
            speed: 1000,
            slidesToScroll: 1,  
    ...
    // PROFILE IMEGES //
    if($('.profile-imeges').length > 0 ){
        $('.profile-imeges').slick({
            autoplay: true, 
            slidesToShow: 3,
            speed: 1000,
            slidesToScroll: 1,  
    ...
    // FRIEND IMEGES // 
   if($('.friend-caption').length > 0 ){
        $('.friend-caption').slick({
            autoplay: true, 
            slidesToShow: 7,
            speed: 1000,
            slidesToScroll: 1,  
    ...
    // about-me-photo//
    if($('.about-me-photo').length > 0 ){
        $('.about-me-photo').slick({
            autoplay: true, 
            slidesToShow: 1,
            speed: 1000,
            slidesToScroll: 1,  
